...
public class Salad2Finish extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_salad2_finish);
        findViewById(R.id.layout).setBackground(getDrawable(Cook.backgroundId));

        interactionWithDatabase = new InteractionWithDatabase((ImageView) findViewById(R.id.like), "1", "salads");
    ...
    public void ListenerOnButton(){
        ...
        buttonNext.setOnClickListener(
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        Intent intent = new Intent(v.getContext(), IngredientsSalad2.whereWasCalled);
        ...
        buttonPrev.setOnClickListener(
                new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent intent = new Intent(v.getContext(), IngredientsSalad2.class);
                        startActivity(intent);
