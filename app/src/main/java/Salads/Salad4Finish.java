...
public class Salad4Finish extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_salad4_finish);
        findViewById(R.id.layout).setBackground(getDrawable(Cook.backgroundId));

        interactionWithDatabase = new InteractionWithDatabase((ImageView) findViewById(R.id.like), "3", "salads");
    ...
    public void ListenerOnButton(){
        ...
        buttonNext.setOnClickListener(
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        Intent intent = new Intent(v.getContext(), IngredientsSalad4.whereWasCalled);
        ...
        buttonPrev.setOnClickListener(
                new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent intent = new Intent(v.getContext(), IngredientsSalad4.class);
                        startActivity(intent);
