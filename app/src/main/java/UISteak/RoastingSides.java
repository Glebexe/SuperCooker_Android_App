...
public class RoastingSides extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_roasting_sides);
        findViewById(R.id.layout).setBackground(getDrawable(Cook.backgroundId));

        TextView textView = findViewById(R.id.textView);
        textView.setText("5) Обжарьте бока стейка.");
    ...
    public void addListenerOnButton(){
        ...
        buttonnext.setOnClickListener(
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        Intent intent = new Intent(v.getContext(), FinishSteak.class);
        ...
        imgCook.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(!pressed1[0]) {
                    pressed1[0] = true;
                    Cook.speak("Прислоните стейк боком к сковородке примерно на 20-30 секунд. Корочка должна быть равномерной по всему куску.     ",
                            findViewById(R.id.textView3));
                }
                else {
                    imgCook.setClickable(false);
                    Cook.timer.cancel();
                    textView1.setText("Прислоните стейк боком к сковородке примерно на 20-30 секунд. Корочка должна быть равномерной по всему куску.   ");
                }
            }
        });
    }
